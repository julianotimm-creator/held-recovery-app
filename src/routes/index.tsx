...
function TermsGate() {
  ...
  return (
    <div className="mt-6 flex flex-col items-center gap-4 lg:items-start">
      ...
      <button
        onClick={handleClick}
        className="w-full rounded-full bg-primary px-8 py-3.5 text-base font-semibold text-primary-foreground transition-opacity hover:opacity-90 sm:w-auto"
      >
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-12 grid items-center gap-10 lg:grid-cols-2">
              <div>
                ...
                <h2 className="mt-4 text-5xl font-bold leading-tight text-foreground sm:text-6xl">
                  When you need to talk, we're here.
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
                  An AI companion that remembers you, understands what you've been going through, and is available 24/7 — especially when no one else is.
                </p>
        ...
        <section className="px-5 py-16 sm:px-8">
          <div className="mx-auto max-w-6xl">
            <h2 className="text-center text-3xl font-bold text-foreground sm:text-4xl">
              For the moments therapy can't cover
            </h2>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-12 max-w-md rounded-3xl border border-border bg-card p-8 text-center shadow-lg">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                We cap membership to protect the quality of every conversation.
              </p>
              <div className="mt-6">
              ...
              <Link
                to="/chat"
                className="mt-6 block w-full rounded-full bg-primary px-8 py-3.5 text-base font-semibold text-primary-foreground transition-opacity hover:opacity-90"
              >
                Start with 10 free messages
              </Link>
            </div>
      ...
      <section className="w-full bg-white px-5 py-12 sm:px-8">
        <div className="mx-auto max-w-3xl rounded-2xl border-2 border-red-200 bg-white p-6 shadow-lg sm:p-10">
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            HELD is a support tool designed to complement professional care. If you are in immediate crisis, experiencing suicidal thoughts, or in danger, please contact emergency services or a crisis helpline immediately.
          </p>
          <div className="mt-6 flex justify-center">
            <div className="w-full max-w-sm rounded-lg bg-gray-100 p-6 text-center">
              ...
              <p className="mt-2 text-xs text-muted-foreground">Call or text:</p>
                ...
                href="tel:988"
                className="mt-1 inline-block text-4xl font-bold text-red-600 transition-opacity hover:opacity-80"
              >
                988
              </a>
          ...
          <p className="mt-6 text-center text-sm font-medium text-foreground">
            Your life matters. If you're struggling, real people are standing by to help — right now. Please reach out.
          </p>
        </div>
      </section>
