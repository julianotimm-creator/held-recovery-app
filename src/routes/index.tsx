...
function TermsGate() {
  ...
  return (
    <div id="consent" className="mt-6 flex scroll-mt-24 flex-col items-center gap-4 lg:items-start">
      <label
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="surface-panel p-6">
              <p className="text-base leading-relaxed text-foreground">
                Continuity means you don't start over. She remembers. She understands. She's not
                just a chatbot — she's the thread that connects your hardest nights.
              </p>
        ...
        {/* 8. Where we are, honestly */}
        <Section
          title="We're just getting started"
          subtitle="No testimonials here yet, because we don't have members yet. When we do — and when they choose to be quoted — their words will go in this space."
        >
          <div className="mb-10 grid gap-4 lg:grid-cols-3">
            ...
            <div className="flex items-center rounded-3xl border border-border bg-card p-6 shadow-sm lg:col-span-2">
              <p className="text-base leading-relaxed text-foreground">
                We would rather tell you the truth about where HELD is than invent praise for it.
                Here is exactly what you are signing up for.
              </p>
            </div>
          </div>
          <Grid cols={3}>
            <Card>
              <h4 className="font-semibold text-foreground">HELD is new</h4>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                It works, it remembers your conversations, and it is there at any hour. It has not
                been used by thousands of people, and we are not going to pretend otherwise.
              </p>
            </Card>
            <Card>
              <h4 className="font-semibold text-foreground">It is not therapy</h4>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                No licensed clinician reviews your conversations. HELD is built to sit alongside
                professional care, never to replace it. If you have a therapist, keep them.
              </p>
            </Card>
            <Card>
              <h4 className="font-semibold text-foreground">Try before you pay</h4>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Your first messages are free and no card is required. If HELD does not help you, do
                not subscribe. We would rather you leave than pay for something that misses.
              </p>
            </Card>
          </Grid>
        </Section>
          ...
          <div className="mt-6 flex justify-center">
            <div className="w-full max-w-sm rounded-xl bg-surface-soft p-6 text-center">
              ...
              <p className="mt-3 text-sm font-semibold text-foreground">
                Emergency:{" "}
                <a href="tel:911" className="text-destructive">
                  911
                </a>
              </p>
            </div>
